...
<div class="ui-widget ui-corner-all ui-widget-about ui-widget-content">
  <div class="ui-widget-header ui-corner-all fg-toolbar">
    <h2><?php echo __('About',array(),'about') ?></h2>
  </div>
  <div class="contributors">
    <h3>e-venement</h3>
    <p><?php echo __("there is worst, but it's more expensive",array(),'about') ?></p>
    <ul>
  ...
  <div class="desc">
    ...
    <p class="editor">
      <?php echo __('insurance',array(),'about') ?>:
      <a href="<?php echo $firm['url'] ?>"><?php echo $firm['name'] ?></a>
      (<?php echo __('gov.',array(),'about') ?>)
    </p>
  </div>
  <div class="mentions">
    <p class="copyleft">
      ...
      et
      <a href="#" class="show-contributors"><?php echo __('the contributors',array(),'about') ?></a>.
      <?php echo __('All rights reserved',array(),'about') ?>.
    </p>
    <p class="license">
      <?php echo __('%e% is licensed under the free license',$translate,'about') ?>
      <a href="http://www.gnu.org/licenses/gpl.html">GNU/GPL</a>.
      <?php echo __('This gives you freedoms, but also you must respect its clauses (attribution, share-alike)',array(),'about') ?>.
    </p>
    <p class="tm">
    ...
    <form action="#" method="get" class="button-contribs">
      <button name="contribs" value="" class="show-contributors">
        <?php echo __('the contributors',array(),'about') ?>
      </button>
    </form>
  </div>
</div>
