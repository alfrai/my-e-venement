<ul class="sf_admin_actions_form">
  ...
  <?php echo $helper->linkToExtraAction($group, array(  'params' => 'class= fg-button ui-state-default fg-button-icon-left ',  'action' => 'csv', 'extra-icon' => 'saveAndAdd', 'label' => 'Extract',)) ?>
