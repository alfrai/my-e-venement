    ...
    <div class="sf_admin_form_row sf_admin_button member_card_submit">
        <div class="widget">
            <a
                ...
                onclick="javascript: var form = $('<form>').append($(this).closest('.sf_admin_form_subform').find('.widget').clone()); $.get($(this).prop('href'), form.serialize(), function(data){ console.error(data); }); return false;"
            >
...
<div class="sf_admin_form_row sf_admin_text member_card_seat">
    <a class="fg-button-mini fg-button ui-state-default fg-button-icon-left"
       ...
       onclick="javascript: $.get($(this).prop('href'), function(data){ console.error(data); }); return false;"
    >
